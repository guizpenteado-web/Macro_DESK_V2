...
class EconomicCalendar:
    ...
    _US_WHITELIST: dict[str, tuple[str, str]] = {
        ...
        # ── Medium — emprego ────────────────────────────────────────────
        "adp employment change weekly":            ("Medium", "Emprego Privado ADP (Semanal)"),
        ...
        "jobless claims 4-week average":            ("Medium", "Pedidos Seguro-Desemprego (Média 4 Semanas)"),
        ...
        "durable goods orders ex defense mom":        ("Medium", "Pedidos Bens Duráveis Ex-Defesa (M/M)"),
        "durable goods orders ex transp mom":         ("Medium", "Pedidos Bens Duráveis Ex-Transporte (M/M)"),
        ...
        "new home sales mom":                          ("Medium", "Vendas Casas Novas (M/M)"),
        ...
        "goods trade balance":                         ("Medium", "Balança Comercial de Bens"),
